...
/**
 * Created by ShimaK on 07-Mar-17.
 */
public class CustomerService {
    ...
    public static void main(String[] args) throws IOException {
        CustomerService server = new CustomerService();
        server.startup();
        server.connect();
    ...
    private void startup() throws IOException {
        ...
        System.out.println("[CUSTOMER SERVICE][" + dateFormat.format(new Date()) + "] - Initializing Simple Server");
    ...
    private boolean manipulateCustomer(HashMap<String, String> input) throws SQLException {
        ...
        try {
            ...
            switch (input.get("SERVICE_TYPE")) {
                case "CREATE":
                    SQL = "INSERT INTO customer VALUES ('" + input.get("NAME") + "','" + input.get("POSITION") + "','"
                ...
                case "UPDATE":
                    ...
                    SQL = "UPDATE customer SET " + column + " = '" + input.get("UPDATE_VALUE")
                            + "' WHERE username = '" + input.get("USERNAME") + "'";
                    break;
                case "DELETE":
                    SQL = "DELETE FROM customer WHERE username='" + input.get("USERNAME") + "'";
                    break;
                default:
                    //TODO throw exception
            }
